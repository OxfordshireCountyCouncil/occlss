...
// extract page headings
  ...
  .use(sass({
    quietDeps: true,
    loadPaths: ['node_modules', 'src/stylesheets', 'src/occlss-scss','node_modules/reflex-grid/scss','node_modules/breakpoint-sass/stylesheets'], // an array of paths that sass can look in when attempt to resolve @import declarations
    sourceMapIncludeSources: true,
    sourceMap: true
  }))

  // Move compiled SASS files from occlss-scss to assets/css
