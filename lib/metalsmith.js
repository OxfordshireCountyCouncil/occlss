...
const sassCnf = {
  ...
  includePaths: ['src/occlss-scss','node_modules/reflex-grid/scss','node_modules/breakpoint-sass/stylesheets'] // an array of paths that sass can look in when attempt to resolve @import declarations
};
