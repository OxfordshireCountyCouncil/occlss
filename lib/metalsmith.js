...
// extract page headings
  ...
  .use(sass({
    quietDeps: true,
    loadPaths: ['node_modules', 'src/stylesheets', 'src/occlss-scss', 'src/sass-new','node_modules/reflex-grid/scss'], // an array of paths that sass can look in when attempt to resolve @import declarations
