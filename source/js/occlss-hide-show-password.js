$(document).ready(function () {
  $('.js-occlss-hide-show').click(function() {
    ...
    if( $(this).hasClass('show') ) {
      $(this).parents('.js-occlss-group-password').children('.occlss-form__input').attr('type','password');
      $(this).children().children('svg').children().attr("xlink:href",imgVisible);
      $(this).removeClass('show');
    } else {
       $(this).parents('.js-occlss-group-password').children('.occlss-form__input').attr('type','text');
    ...
    $('.js-occlss-hide-show').children().children('svg').children().attr("xlink:href",imgVisible);
		...
		$('.js-occlss-hide-show').parents('.js-occlss-group-password').children('.occlss-form__input').attr('type','password');
  }); 
});