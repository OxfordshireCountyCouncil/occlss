...
BackToTop.prototype.init = function () {
  ...
  if (!('IntersectionObserver' in window)) {
    ...
    return this.$module.classList.remove('doc-back-to-top--hidden')
  }

  var $footer = document.querySelector('.js-doc-page-footer')
  var $subNav = document.querySelector('.js-doc-subnav')
  ...
  var observer = new window.IntersectionObserver(function (entries) {
    ...
    if (subNavIsIntersecting || footerIsIntersecting) {
      this.$module.classList.remove('doc-back-to-top--fixed')
    } else {
      this.$module.classList.add('doc-back-to-top--fixed')
    }
    ...
    if (subNavIsIntersecting && subNavIntersectionRatio === 1) {
      this.$module.classList.add('doc-back-to-top--hidden')
    } else {
      this.$module.classList.remove('doc-back-to-top--hidden')
    }
  }.bind(this))
