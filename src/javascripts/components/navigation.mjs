...
var navActiveClass = 'doc-navigation--active'
var navMenuButtonActiveClass = 'doc-header__menu-button--open'
var subNavActiveClass = 'doc-navigation__subnav--active'
// This one has the query dot at the beginning because it's only ever used in querySelector calls
var subNavJSClass = '.js-doc-navigation__subnav'

function Navigation ($module) {
  this.$module = $module || document

  this.$nav = this.$module.querySelector('.js-doc-navigation')
  this.$navToggler = this.$module.querySelector('.js-doc-navigation__toggler')
  this.$navButtons = this.$module.querySelectorAll('.js-doc-navigation__button')
  this.$navLinks = this.$module.querySelectorAll('.js-doc-navigation__link')
...
Navigation.prototype.init = function () {
  if ('matchMedia' in window) {
    // Set the matchMedia to the OCCLSS tablet breakpoint
