  ...
  if (result) {
    ...
    if (result.aliases) {
      ...
      if (matchedAliases.length > 0) {
        ...
        aliasesContainer.className = 'doc-site-search__aliases'
        aliasesContainer.textContent = matchedAliases.join(', ')
        elem.appendChild(aliasesContainer)
      }
    }
    var section = document.createElement('span')
    section.className = 'doc-site-search--section'
...
Search.prototype.init = function () {
  ...
  accessibleAutocomplete({
    element: $module,
    id: 'doc-site-search__input',
    cssNamespace: 'doc-site-search',
    displayMenu: 'overlay',
  ...
  var $input = $module.querySelector('.doc-site-search__input')
