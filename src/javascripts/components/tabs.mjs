 ...
 * - doc-tabs, js-tabs - groups of classes used by the tabs component
...
AppTabs.prototype.enhanceMobileTabs = function () {
  ...
  nodeListForEach(this.$mobileTabs, function ($tab) {
    ...
    $button.classList.add('doc-tabs__heading-button')
...
AppTabs.prototype.openPanel = function (panelId) {
  ...
  if ($mobileTab && $desktopTab) {
    ...
    $mobileTab.parentNode.classList.add('doc-tabs__heading--current')
    $desktopTab.setAttribute('aria-expanded', 'true')
    $desktopTab.parentNode.classList.add('doc-tabs__item--current')
  }
...
AppTabs.prototype.closePanel = function (panelId) {
  ...
  $mobileTab.parentNode.classList.remove('doc-tabs__heading--current')
  $desktopTab.parentNode.classList.remove('doc-tabs__item--current')
...
AppTabs.prototype.getDesktopTab = function (panelId) {
  var $desktopTabContainer = this.$module.querySelector('.doc-tabs')
